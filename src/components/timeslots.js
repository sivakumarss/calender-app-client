// @flow   ---  Original file  from   https://github.com/dennis-chee/tal-calendar-app/blob/main/src/components/molecules/TimeSlots/index.js
...
class TimeSlots extends React.Component {
   ...
   // hourSplitAmount; 1=hour 2=half hour, 4=15 minutes
    ...
    SetBookingSlotsAsUnavailable (bookingSlots, initialSlots) {
        debugger;
        return bookingSlots.map((slot, index) => {
            let newSlot = slot
    ...
    render() {
        return (
            <React.Fragment>
                <h1>TAL Day calender booking</h1>
